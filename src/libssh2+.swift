...
typealias sendType = @convention(c) (libssh2_socket_t, UnsafeRawPointer, ssize_t, CInt, UnsafeRawPointer) -> Int
...
typealias recvType = @convention(c) (libssh2_socket_t, UnsafeMutableRawPointer, ssize_t, CInt, UnsafeRawPointer) -> Int
...
typealias disconnectType = @convention(c) (
    UnsafeRawPointer,
    CInt,
    UnsafePointer<CChar>,
    CInt,
...
///   - code: 相关的错误或状态码
///   - abstract: 用户上下文指针
typealias debugType = @convention(c) (
    UnsafeRawPointer,
    CInt,
    UnsafePointer<CChar>,
    CInt,
